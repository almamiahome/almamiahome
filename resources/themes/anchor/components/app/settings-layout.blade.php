        ...
        <aside class="flex-shrink-0 pb-8 lg:pt-4 lg:pb-0 lg:w-48">
            <nav class="flex items-start justify-start lg:flex-col lg:space-y-1">
                ...
                <div class="flex items-center w-auto space-x-2 lg:items-stretch lg:flex-col lg:w-full lg:space-y-1 lg:space-x-0">
                    <x-settings-sidebar-link :href="route('settings.profile')" icon="phosphor-user-circle-duotone">Peril</x-settings-sidebar-link>
                    <x-settings-sidebar-link :href="route('settings.security')" icon="phosphor-lock-duotone">Seguridad</x-settings-sidebar-link>
...
<x-settings-sidebar-link :href="route('settings.api')" icon="phosphor-code-duotone">API Keys</x-settings-sidebar-link>
                    <x-settings-sidebar-link :href="route('settings.custom-css')" icon="phosphor-code-block-duotone">CSS personalizado</x-settings-sidebar-link>
                    <x-settings-sidebar-link :href="route('settings.custom-js')" icon="phosphor-brackets-curly-duotone">JavaScript personalizado</x-settings-sidebar-link>
