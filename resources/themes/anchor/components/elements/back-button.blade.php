<div {{ $attributes->twMerge('lg:px-5 mx-auto w-full lg:px-0') }}>
    <a href="{{ $href ?? '' }}" wire:navigate class="inline-flex items-center px-3 py-1.5 mb-3 lg:mb-1 md:mb-6 text-xs font-semibold rounded-full border border-white/60 dark:border-sky-300/20 cursor-pointer text-slate-800 dark:text-slate-100 bg-white/60 dark:bg-slate-900/60 backdrop-blur-lg group hover:bg-white/80 dark:hover:bg-slate-900/80 transition-colors">
