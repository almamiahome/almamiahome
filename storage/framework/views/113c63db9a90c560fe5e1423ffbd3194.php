<nav class="flex justify-between items-center py-2 w-full text-xs">
    <ol role="list" class="flex items-center space-x-1">
        <li>
            <button wire:click="goToDirectory('/')" class="<?php if($this->isRootDirectory()): ?><?php echo e('bg-gray-100'); ?><?php else: ?><?php echo e('bg-transparent'); ?><?php endif; ?> inline-flex items-center px-3 py-2 font-normal text-center text-gray-900 rounded-md hover:bg-gray-100 focus:outline-none">
        ...
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <li>
                <button 
                    wire:click="goToDirectory('<?php echo e($breadcrumb->location); ?>')" 
                    class="<?php if($loop->last): ?> bg-gray-100 <?php else: ?> bg-transparent <?php endif; ?>
                    ...
                    <span><?php echo e($breadcrumb->display); ?></span>
                </button>
            </li>
...
</nav><?php /**PATH /home/unquxtyh/public_html/wave/src/../resources/views/media/views/breadcrumbs.blade.php ENDPATH**/ ?>