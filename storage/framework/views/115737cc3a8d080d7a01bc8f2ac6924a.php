...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e1fe0a65a45e979f68b20da5606ecdcc::app.heading','data' => ['title' => 'Categorías','description' => 'Listado de categorías','border' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Categorías','description' => 'Listado de categorías','border' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['tag' => 'a','href' => '/categorias/create']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => '/categorias/create']); ?>Nueva Categoría <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['tag' => 'a','href' => '/categorias/masivo','class' => 'bg-indigo-500 hover:bg-indigo-600 text-white']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => '/categorias/masivo','class' => 'bg-indigo-500 hover:bg-indigo-600 text-white']); ?>
                        Creación masiva
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
                    ...
                    <table class="min-w-full bg-white">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-4 py-2"><?php echo e($categoria->nombre); ?></td>
                                    <td class="px-4 py-2 text-gray-600"><?php echo e($categoria->slug ?? '—'); ?></td>
                                    <td class="px-4 py-2 text-gray-600">
                                        <?php echo e(optional($categoria->puntajeRegla->first())->descripcion ? \Illuminate\Support\Str::limit($categoria->puntajeRegla->first()->descripcion, 60) : 'Sin asignar'); ?>

                                    </td>
                                    <td class="px-4 py-2">
                                        <button wire:click="editCategoria(<?php echo e($categoria->id); ?>)" class="mr-2 text-blue-500 hover:underline">Editar</button>
                                        <button wire:click="deleteCategoria(<?php echo e($categoria->id); ?>)" class="text-red-500 hover:underline">Eliminar</button>
                                    </td>
                                </tr>
                            ...
                            <div>
                                ...
                                <select wire:model.live="categoria_ids" multiple class="w-full border-gray-300 rounded-md shadow-xs focus:ring focus:ring-indigo-200">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $reglas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $regla): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($regla->id); ?>"><?php echo e(\Illuminate\Support\Str::limit($regla->descripcion ?? 'Regla ' . $regla->id, 60)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                </select>
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['categoria_ids'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-500"><?php echo e($message); ?></span> <?php unset($message);
...
<?php endif; ?>
    <?php /**PATH /home/unquxtyh/public_html/storage/framework/views/18e8b04fb0e329ecb61f2da9c8c2af87.blade.php ENDPATH**/ ?>