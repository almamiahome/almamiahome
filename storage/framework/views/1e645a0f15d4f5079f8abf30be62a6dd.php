...
?>
    ...
    |---LINE:279---|<?php if (isset($component)) { $__componentOriginal08db35abc15b88d7e891883ef0dd6bed = $component; } ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e1fe0a65a45e979f68b20da5606ecdcc::app.container','data' => ['xData' => '{
        ...
        }','xCloak' => true,'class' => 'space-y-6 pb-12']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['x-data' => '{
        ...
        }','x-cloak' => true,'class' => 'space-y-6 pb-12']); ?>
                ...
                <div class="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div class="space-y-4">
                        <div class="inline-flex items-center gap-2 rounded-lg bg-[#294395]/5 px-3 py-1.5 text-xs font-bold uppercase tracking-wider text-[#294395] ring-1 ring-[#294395]/10">
                            ...
                            Rol Activo: |---LINE:304---|<?php echo e(ucfirst($rolActual)); ?>

                        </div>
                        <div>
                            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight sm:text-4xl">
                                Bienvenido, |---LINE:308---|<?php echo e($usuario?->name); ?> 👋
                            </h1>
                            <p class="mt-2 text-sm text-slate-500 font-medium max-w-xl">
                                |---LINE:311---|<?php echo e($config['titulo']); ?>. |---LINE:311---|<?php echo e($config['subtitulo']); ?>
                    ...
                    <div class="flex-shrink-0 text-left md:text-right">
                        <div class="inline-flex flex-col rounded-2xl bg-slate-50 px-5 py-3 ring-1 ring-slate-200/60">
                            ...
                            <span class="mt-1 text-sm font-bold text-slate-700">
                                <span class="text-[#294395]">|---LINE:320---|<?php echo e($metaPedidos); ?></span> Pedidos · 
                                <span class="text-[#e91e63]">|---LINE:321---|<?php echo e($metaPuntos); ?></span> Pts
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto mb-12 flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div class="flex items-center gap-4 text-zinc-500 dark:text-zinc-400">
            <div class="text-right hidden sm:block">
                <p class="text-lg font-semibold leading-none text-zinc-800 dark:text-zinc-200" id="os-clock">|---LINE:337---|<?php echo e(now()->format('H:i')); ?></p>
                <p class="text-xs uppercase tracking-tighter">|---LINE:338---|<?php echo e(now()->translatedFormat('l, d \d\e F')); ?></p>
            </div>
            <div class="h-10 w-px bg-zinc-200 dark:bg-zinc-800 hidden sm:block"></div>
            |---LINE:341---|<?php if (isset($component)) { $__componentOriginal262b77ea6d221dabc34c6f9febac9fba = $component; } ?>
...
<?php endif; ?>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-9 gap-y-10 gap-x-4">
        ...
        |---LINE:396---|<!--[if BLOCK]><![endif]--><?php $__currentLoopData = $allApps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            |---LINE:397---|<!--[if BLOCK]><![endif]--><?php if($app['role']): ?>
                <div class="flex flex-col items-center group">
                    <a href="|---LINE:399---|<?php echo e($app['href']); ?>" 
                       wire:navigate 
                       class="relative flex flex-col items-center gap-3 no-underline outline-none focus:ring-0">
                        
                        <div class="relative">
                            <div class="absolute inset-0 |---LINE:404---|<?php echo e($app['color']); ?> opacity-20 blur-xl group-hover:opacity-40 transition-opacity duration-500 rounded-2xl"></div>
                            
                            <div class="|---LINE:406---|<?php echo e($app['color']); ?> w-16 h-16 sm:w-[72px] sm:h-[72px] rounded-[1.4rem] shadow-xl flex items-center justify-center text-white relative overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:scale-110 group-hover:-translate-y-2 group-active:scale-95 group-active:translate-y-0 border-t border-white/20">
                                
                                |---LINE:408---|<?php if (isset($component)) { $__componentOriginal511d4862ff04963c3c16115c05a86a9d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal511d4862ff04963c3c16115c05a86a9d = $attributes; } ?>
<?php $component = Illuminate\View\DynamicComponent::resolve(['component' => $app['icon']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 sm:w-9 sm:h-9 text-white drop-shadow-lg relative z-10']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <span class="text-[11px] sm:text-[12px] font-semibold text-zinc-600 dark:text-zinc-400 text-center leading-tight tracking-tight w-24 line-clamp-2 transition-colors group-hover:text-zinc-900 dark:group-hover:text-white">
                            |---LINE:415---|<?php echo e($app['label']); ?>

                        </span>
                    </a>
                </div>
            |---LINE:419---|<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        |---LINE:420---|<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
...
<style>
    ...
    |---LINE:440---|<!--[if BLOCK]><![endif]--><?php for: ?> $i from 1 through 35 {
...
<script>
    ...
    setInterval(updateClock, 1000);
            ...
            <div class="flex flex-col gap-6 lg:col-span-4">
                <div class="flex-1 rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm flex flex-col justify-center relative overflow-hidden group">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-xl font-black text-[#294395]">|---LINE:470---|<?php echo e($avancePedidos); ?>%</span>
                    </div>
                    <div class="h-2 w-full overflow-hidden rounded-full bg-slate-100">
                        <div class="h-full rounded-full bg-[#294395] transition-all duration-1000 ease-out" style="width: |---LINE:473---|<?php echo e($avancePedidos); ?>%"></div>
                    </div>
                    <p class="mt-3 text-xs font-medium text-slate-400 text-right">|---LINE:475---|<?php echo e($pedidosTotales); ?> / |---LINE:475---|<?php echo e($metaPedidos); ?> meta</p>
                </div>
                ...
                <div class="flex-1 rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm flex flex-col justify-center relative overflow-hidden group">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-xl font-black text-[#e91e63]">|---LINE:482---|<?php echo e($puntosTotal); ?></span>
                    </div>
                    <div class="h-2 w-full overflow-hidden rounded-full bg-slate-100">
                        <div class="h-full rounded-full bg-[#e91e63] transition-all duration-1000 ease-out" style="width: |---LINE:485---|<?php echo e($avancePuntos); ?>%"></div>
                    </div>
                    <p class="mt-3 text-xs font-medium text-slate-400 text-right">Sugerido: |---LINE:487---|<?php echo e($metaPuntos); ?> pts</p>
                </div>
            </div>
        </section>

        <section class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            |---LINE:493---|<!--[if BLOCK]><![endif]--><?php $__currentLoopData = $config['acciones']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="|---LINE:494---|<?php echo e(url($accion['ruta'])); ?>" class="group flex flex-col justify-between rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md hover:ring-[#294395]/30">
                    <div>
                        ...
                        <h3 class="text-base font-bold text-slate-900">|---LINE:501---|<?php echo e($accion['titulo']); ?></h3>
                        <p class="mt-2 text-xs font-medium text-slate-500 leading-relaxed">|---LINE:502---|<?php echo e($accion['descripcion']); ?></p>
                    </div>
            ...
            |---LINE:509---|<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
        </section>

        |---LINE:512---|<!--[if BLOCK]><![endif]--><?php if($rolActual !== 'admin'): ?>
            <section class="grid gap-6 lg:grid-cols-12">
                    ...
                    <div class="grid gap-6 flex-1 content-start">
                            ...
                            <div class="group relative">
                                <div class="flex items-end justify-between mb-2">
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-500">|---LINE:529---|<?php echo e($metaPedidos); ?> pedidos para lograrlo</p>
                                    </div>
                                    <span class="text-sm font-black text-[#294395]">|---LINE:531---|<?php echo e($avancePedidos); ?>%</span>
                                </div>
                                <div class="h-2 w-full overflow-hidden rounded-full bg-slate-100">
                                    <div class="h-full rounded-full bg-gradient-to-r from-[#294395] to-[#4b68c9]" style="width: |---LINE:534---|<?php echo e($avancePedidos); ?>%"></div>
                                </div>
                            </div>
                            ...
                            <div class="group relative">
                                <div class="flex items-end justify-between mb-2">
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-500">|---LINE:542---|<?php echo e($metaPuntos); ?> puntos para nuevo rango</p>
                                    </div>
                                    <span class="text-sm font-black text-[#e91e63]">|---LINE:544---|<?php echo e($avancePuntos); ?>%</span>
                                </div>
                                <div class="h-2 w-full overflow-hidden rounded-full bg-slate-100">
                                    <div class="h-full rounded-full bg-gradient-to-r from-[#e91e63] to-[#ff6b9d]" style="width: |---LINE:547---|<?php echo e($avancePuntos); ?>%"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-auto pt-6 grid grid-cols-3 gap-4 border-t border-slate-100">
                            <div>
                                ...
                                <p class="mt-1 text-2xl font-black text-slate-900">|---LINE:555---|<?php echo e($pedidosTotales); ?></p>
                            </div>
                            <div>
                                <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400">Puntos Netos</p>
                                <p class="mt-1 text-2xl font-black text-[#e91e63]">|---LINE:559---|<?php echo e($puntosTotal); ?></p>
                            </div>
                            <div>
                                <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400">Unidades</p>
                                <p class="mt-1 text-2xl font-black text-[#294395]">|---LINE:563---|<?php echo e($unidadesTotales); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-3xl bg-white p-0 ring-1 ring-slate-200/60 shadow-sm lg:col-span-5 flex flex-col overflow-hidden">
                    <div class="flex items-center justify-between p-6 pb-4 border-b border-slate-100">
                        ...
                        <a href="|---LINE:572---|<?php echo e(url('/mis-pedidos')); ?>" class="text-xs font-bold uppercase tracking-wider text-[#294395] hover:text-[#e91e63] transition-colors">Ver historial</a>
                    </div>
                    
                    <div class="flex-1 overflow-y-auto divide-y divide-slate-100 p-2">
                        |---LINE:576---|<!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $pedidosRecientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex items-center justify-between p-4 rounded-2xl hover:bg-slate-50 transition-colors">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-slate-900">Pedido #|---LINE:583---|<?php echo e($pedido->codigo_pedido ?? $pedido->id); ?></p>
                                        <p class="text-xs text-slate-500 mt-0.5">|---LINE:584---|<?php echo e($pedido->fecha ?? $pedido->created_at?->format('d/m/Y') ?? 'Sin fecha'); ?></p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <p class="text-sm font-black text-[#e91e63]">|---LINE:588---|<?php echo e($pedido->total_puntos ?? 0); ?> <span class="text-[10px] uppercase text-slate-400">pts</span></p>
                                    <p class="text-[10px] font-bold uppercase tracking-wider text-slate-400 mt-1">|---LINE:589---|<?php echo e(ucfirst($pedido->estado ?? 'Revisión')); ?></p>
                                </div>
                            </div>
                        |---LINE:592---|<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        |---LINE:600---|<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                </div>
            </section>
        |---LINE:604---|<?php endif; ?><!--[if ENDBLOCK]><![endif]-->

        |---LINE:606---|<!--[if BLOCK]><![endif]--><?php if($rolActual === 'admin'): ?>
            <section class="space-y-6">
                <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm">
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                        ...
                        <form method="GET" action="|---LINE:618---|<?php echo e(route('dashboard')); ?>" class="flex flex-wrap items-end gap-3 rounded-2xl bg-slate-50 p-3 ring-1 ring-slate-100">
                            <label class="flex flex-col gap-1.5">
                                ...
                                <select name="filtro" class="h-10 rounded-xl border-0 bg-white px-4 text-sm font-bold text-slate-700 ring-1 ring-slate-200 focus:ring-2 focus:ring-[#294395] cursor-pointer">
                                    <option value="mes" |---LINE:622---|<?php if($filtroAdmin === 'mes'): echo 'selected'; endif; ?>>Mensual</option>
                                    <option value="rango" |---LINE:623---|<?php if($filtroAdmin === 'rango'): echo 'selected'; endif; ?>>Rango personalizado</option>
                                </select>
                            </label>

                            <label class="flex flex-col gap-1.5">
                                <span class="text-[10px] font-bold uppercase tracking-wider text-slate-500 px-1">Mes</span>
                                <input name="mes" type="month" value="|---LINE:629---|<?php echo e($mesAdmin); ?>" class="h-10 rounded-xl border-0 bg-white px-4 text-sm font-bold text-slate-700 ring-1 ring-slate-200 focus:ring-2 focus:ring-[#294395]" />
                            </label>

                            <label class="flex flex-col gap-1.5">
                                <span class="text-[10px] font-bold uppercase tracking-wider text-slate-500 px-1">Desde</span>
                                <input name="fecha_inicio" type="date" value="|---LINE:634---|<?php echo e($fechaInicioAdmin); ?>" class="h-10 rounded-xl border-0 bg-white px-4 text-sm font-bold text-slate-700 ring-1 ring-slate-200 focus:ring-2 focus:ring-[#294395]" />
                            </label>

                            <label class="flex flex-col gap-1.5">
                                <span class="text-[10px] font-bold uppercase tracking-wider text-slate-500 px-1">Hasta</span>
                                <input name="fecha_fin" type="date" value="|---LINE:639---|<?php echo e($fechaFinAdmin); ?>" class="h-10 rounded-xl border-0 bg-white px-4 text-sm font-bold text-slate-700 ring-1 ring-slate-200 focus:ring-2 focus:ring-[#294395]" />
                            </label>
                ...
                <div class="grid gap-6 md:grid-cols-3">
                    <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm border-l-4 border-l-[#294395]">
                        ...
                        <p class="text-3xl font-black text-slate-900">|---LINE:652---|<?php echo e(number_format($resumenAdmin['unidades_vendidas'], 0, ',', '.')); ?></p>
                    </div>
                    <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm border-l-4 border-l-indigo-400">
                        ...
                        <p class="text-3xl font-black text-slate-900"><span class="text-slate-400 text-2xl mr-1">$</span>|---LINE:656---|<?php echo e(number_format($resumenAdmin['total_catalogo_vendido'], 2, ',', '.')); ?></p>
                    </div>
                    <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm border-l-4 border-l-[#e91e63]">
                        ...
                        <p class="text-3xl font-black text-[#e91e63]"><span class="text-[#e91e63]/50 text-2xl mr-1">$</span>|---LINE:660---|<?php echo e(number_format($resumenAdmin['total_facturado'], 2, ',', '.')); ?></p>
                    </div>
                </div>
                ...
                <div class="grid gap-6 lg:grid-cols-2">
                    ...
                    <div class="rounded-3xl bg-white ring-1 ring-slate-200/60 shadow-sm overflow-hidden flex flex-col">
                        ...
                        <div class="overflow-x-auto p-2">
                            <table class="w-full text-left text-sm whitespace-nowrap">
                                ...
                                <tbody>
                                    |---LINE:681---|<!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $ultimosPedidosAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-slate-50 rounded-xl transition-colors">
                                            <td class="px-4 py-3 font-bold text-[#294395]">#|---LINE:683---|<?php echo e($pedido->codigo_pedido); ?></td>
                                            <td class="px-4 py-3 text-slate-500">|---LINE:684---|<?php echo e($pedido->fecha ? Carbon::parse($pedido->fecha)->format('d/m/Y') : 'N/A'); ?></td>
                                            <td class="px-4 py-3 font-medium text-slate-700">|---LINE:685---|<?php echo e($pedido->vendedora?->name ?? 'Sin vendedora'); ?></td>
                                            <td class="px-4 py-3 text-right font-black text-slate-900">$|---LINE:686---|<?php echo e(number_format((float) $pedido->total_a_pagar, 2, ',', '.')); ?></td>
                                        </tr>
                                    |---LINE:688---|<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr><td colspan="4" class="px-4 py-8 text-center text-xs text-slate-400">No hay pedidos registrados en este período.</td></tr>
                                    |---LINE:690---|<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="rounded-3xl bg-white ring-1 ring-slate-200/60 shadow-sm overflow-hidden flex flex-col">
                        ...
                        <div class="overflow-x-auto p-2">
                            <table class="w-full text-left text-sm whitespace-nowrap">
                                ...
                                <tbody>
                                    |---LINE:710---|<!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $ultimosRegistrosAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-slate-50 rounded-xl transition-colors">
                                            <td class="px-4 py-3 font-bold text-slate-900">|---LINE:712---|<?php echo e($registro->name); ?></td>
                                            <td class="px-4 py-3 text-slate-500 text-xs">|---LINE:713---|<?php echo e($registro->email); ?></td>
                                            <td class="px-4 py-3 text-right text-slate-500 text-xs">|---LINE:714---|<?php echo e($registro->created_at?->format('d/m/y H:i')); ?></td>
                                        </tr>
                                    |---LINE:716---|<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr><td colspan="3" class="px-4 py-8 text-center text-xs text-slate-400">No hay registros recientes.</td></tr>
                                    |---LINE:718---|<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm">
                        ...
                        <div class="space-y-3">
                            |---LINE:730---|<!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topVendedorasAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $vendedora): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="flex items-center justify-between p-3 rounded-2xl bg-slate-50 border border-slate-100/50">
                                    <div class="flex items-center gap-3">
                                        <span class="flex h-6 w-6 items-center justify-center rounded-full bg-white text-[10px] font-black text-slate-400 ring-1 ring-slate-200 shadow-sm">|---LINE:733---|<?php echo e($index + 1); ?></span>
                                        <span class="font-bold text-slate-700 text-sm">|---LINE:734---|<?php echo e($vendedora->name); ?></span>
                                    </div>
                                    <span class="font-black text-[#e91e63] text-sm">$|---LINE:736---|<?php echo e(number_format((float) $vendedora->total_ventas, 2, ',', '.')); ?></span>
                                </div>
                            |---LINE:738---|<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="p-4 text-center text-xs text-slate-400">Sin datos para mostrar.</div>
                            |---LINE:740---|<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                    </div>
                    ...
                    <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm">
                        ...
                        <div class="space-y-3">
                            |---LINE:750---|<!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topLideresAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="flex items-center justify-between p-3 rounded-2xl bg-slate-50 border border-slate-100/50">
                                    <div class="flex items-center gap-3">
                                        <span class="flex h-6 w-6 items-center justify-center rounded-full bg-white text-[10px] font-black text-slate-400 ring-1 ring-slate-200 shadow-sm">|---LINE:753---|<?php echo e($index + 1); ?></span>
                                        <span class="font-bold text-slate-700 text-sm">|---LINE:754---|<?php echo e($lider->name); ?></span>
                                    </div>
                                    <span class="font-black text-[#294395] text-sm">$|---LINE:756---|<?php echo e(number_format((float) $lider->total_ventas, 2, ',', '.')); ?></span>
                                </div>
                            |---LINE:758---|<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="p-4 text-center text-xs text-slate-400">Sin datos para mostrar.</div>
                            |---LINE:760---|<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                    </div>
                </div>
        ...
        |---LINE:793---|<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php endif; ?>
    |---LINE:844---|<?php /**PATH /home/unquxtyh/public_html/storage/framework/views/f1e5d7a5fe13498abbdeb0f1f19136a8.blade.php ENDPATH**/ ?>