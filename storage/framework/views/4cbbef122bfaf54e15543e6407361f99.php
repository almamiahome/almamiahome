...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.modal.index','data' => ['id' => 'move-file-modal','width' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'move-file-modal','width' => 'lg']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.input.select','data' => ['wire:model' => 'destinationFolder','label' => 'Select Destination Folder','placeholder' => 'Select a folder']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'destinationFolder','label' => 'Select Destination Folder','placeholder' => 'Select a folder']); ?>
                <option value="" disabled selected>Select a folder</option>
                <!--[if BLOCK]><![endif]--><?php if(!$this->isRootDirectory()): ?>
                    <option value=".." selected>Previous Folder (../)</option>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->getFoldersInCurrentDirectory(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!--[if BLOCK]><![endif]--><?php if($selectedFile != null && $selectedFile['name'] != $folder): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['type' => 'submit','wire:click' => 'moveFileOrFolder']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','wire:click' => 'moveFileOrFolder']); ?>
            Move
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/unquxtyh/public_html/wave/src/../resources/views/media/views/header/move.blade.php ENDPATH**/ ?>