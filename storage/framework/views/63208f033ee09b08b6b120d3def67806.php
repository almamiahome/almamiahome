...
>
    ...
    >
        <span x-show="(theme == 'light' || theme == null)">Oscuro</span>
        <span x-show="(theme == 'dark')">Modo Claro</span>
    </label>

</div><?php /**PATH /home/unquxtyh/public_html/resources/themes/anchor/components/app/light-dark-toggle.blade.php ENDPATH**/ ?>