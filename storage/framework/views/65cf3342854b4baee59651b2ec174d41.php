...
<?php $component->withAttributes([]); ?>
        ...
        >
            ...
            <a href="<?php echo e(url('/catalogo')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700 transition">
                Ir a Catálogo
            </a>
            </div>
...
<?php endif; ?>
    <?php /**PATH /home/unquxtyh/public_html/storage/framework/views/ad1abba5ef24587a718d7b9b411e5492.blade.php ENDPATH**/ ?>