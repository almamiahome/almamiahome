<header class="w-full">
    <div class="flex space-x-3 w-full">
        <div class="flex overflow-hidden flex-shrink-0 rounded divide-x divide-gray-700">
            ...
            <?php echo $__env->make('wave::media.views.header.add-folder', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        ...
        <div class="flex-1">
            <?php echo $__env->make('wave::media.views.header.search', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

        <div class="flex overflow-hidden flex-shrink-0 rounded divide-x divide-gray-200 ring-1 ring-gray-200">
            <?php echo $__env->make('wave::media.views.header.move', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            
            <?php echo e($this->deleteAction); ?>
    ...
    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['upload'];
...
</header><?php /**PATH /home/unquxtyh/public_html/wave/src/../resources/views/media/views/header.blade.php ENDPATH**/ ?>