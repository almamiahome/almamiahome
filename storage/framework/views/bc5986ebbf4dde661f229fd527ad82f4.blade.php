...
?>
        ...
        |---LINE:25---|<x-app.container>
            <div class="flex flex-col mb-8 gap-4">
                |---LINE:27---|<x-app.heading
                    title="Marketplace"
                    ...
                    <div class="overflow-hidden bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center justify-between mt-4">
                                ...
                                |---LINE:56---|<x-button class="text-xs">Ver detalle</x-button>
                            </div>
                        </div>
                    </div>
                |---LINE:60---|@empty
