    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto flex flex-col gap-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-zinc-600 dark:text-zinc-400 font-medium">Almamia Home — <?php echo e(now()->format('H:i')); ?></p>
            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight sm:text-4xl">
                                Bienvenido, <?php echo e($usuario?->name); ?> 👋
                            </h1>
                    ...
                    <div class="flex-shrink-0">
                        <div class="inline-flex flex-col rounded-2xl bg-white/50 dark:bg-zinc-800/50 px-5 py-3 border border-white/20">
                            ...
                            <span class="mt-1 text-sm font-bold text-slate-700 dark:text-zinc-200">
                                <span class="text-[#294395] dark:text-blue-400"><?php echo e($metaPedidos); ?></span> Pedidos · 
                                <span class="text-[#e91e63]"><?php echo e($metaPuntos); ?></span> Pts
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col gap-6 lg:col-span-4">
                <div class="flex-1 rounded-3xl bg-white/70 dark:bg-zinc-900/70 p-6 border border-white/50 dark:border-zinc-800 shadow-xl flex flex-col justify-center relative overflow-hidden group transition-all">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-xl font-black text-[#294395] dark:text-blue-400"><?php echo e($avancePedidos); ?>%</span>
                    </div>
                    <div class="h-2 w-full overflow-hidden rounded-full bg-slate-200/50 dark:bg-zinc-800">
                        <div class="h-full rounded-full bg-[#294395] transition-all duration-1000 ease-out" style="width: <?php echo e($avancePedidos); ?>%"></div>
                    </div>
                    <p class="mt-3 text-xs font-medium text-slate-400 text-right"><?php echo e($pedidosTotales); ?> / <?php echo e($metaPedidos); ?> meta</p>
                </div>

                <div class="flex-1 rounded-3xl bg-white/70 dark:bg-zinc-900/70 p-6 border border-white/50 dark:border-zinc-800 shadow-xl flex flex-col justify-center relative overflow-hidden group transition-all">
                    <div class="flex items-center justify-between mb-4">
                        <span class="text-xs font-bold uppercase tracking-wider text-slate-500">Puntos Acumulados</span>
                        <span class="text-xl font-black text-[#e91e63]"><?php echo e($puntosTotal); ?></span>
                    </div>
                    <div class="h-2 w-full overflow-hidden rounded-full bg-slate-200/50 dark:bg-zinc-800">
                        <div class="h-full rounded-full bg-[#e91e63] transition-all duration-1000 ease-out" style="width: <?php echo e($avancePuntos); ?>%"></div>
                    </div>
                    <p class="mt-3 text-xs font-medium text-slate-400 text-right">Sugerido: <?php echo e($metaPuntos); ?> pts</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-x-4 gap-y-10 py-4">
            ...
            <?php $__currentLoopData = $apps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($app['show']): ?>
                    <a href="<?php echo e($app['ruta']); ?>" wire:navigate class="app-item group flex flex-col items-center outline-none">
                        <div class="relative">
                            <div class="absolute inset-0 <?php echo e($app['color']); ?> opacity-20 blur-xl group-hover:opacity-50 transition-opacity rounded-full"></div>
                            <div class="<?php echo e($app['color']); ?> w-16 h-16 sm:w-[72px] sm:h-[72px] rounded-[1.5rem] shadow-lg flex items-center justify-center text-white relative overflow-hidden transition-all duration-500 group-hover:scale-105 group-hover:-translate-y-2 group-active:scale-90 border-t border-white/30 shadow-<?php echo e(str_replace('bg-', '', $app['color'])); ?>/40">
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 sm:w-9 sm:h-9 text-white drop-shadow-md z-10']); ?>
...
<style>
    ...
    <?php for($i = 1; $i <= 30; $i++): ?>
        .app-item:nth-child(<?php echo e($i); ?>) {
            animation-delay: <?php echo e(0.1 + ($i * 0.05)); ?>s;
        }
    <?php endfor; ?>
</style>
  ...
  <!-- <section class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            <?php $__currentLoopData = $config['acciones']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(url($accion['ruta'])); ?>" class="group flex flex-col justify-between rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md hover:ring-[#294395]/30">
                    <div>
                        ...
                        <h3 class="text-base font-bold text-slate-900"><?php echo e($accion['titulo']); ?></h3>
                        <p class="mt-2 text-xs font-medium text-slate-500 leading-relaxed"><?php echo e($accion['descripcion']); ?></p>
                    </div>
            ...
            <section class="grid gap-6 lg:grid-cols-12">
                    ...
                    <div class="grid gap-6 flex-1 content-start">
                            ...
                            <div class="group relative">
                                <div class="flex items-end justify-between mb-2">
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-500"><?php echo e($metaPedidos); ?> pedidos para lograrlo</p>
                                    </div>
                                    <span class="text-sm font-black text-[#294395]"><?php echo e($avancePedidos); ?>%</span>
                                </div>
                                <div class="h-2 w-full overflow-hidden rounded-full bg-slate-100">
                                    <div class="h-full rounded-full bg-gradient-to-r from-[#294395] to-[#4b68c9]" style="width: <?php echo e($avancePedidos); ?>%"></div>
                                </div>
                            </div>
                            ...
                            <div class="group relative">
                                <div class="flex items-end justify-between mb-2">
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-500"><?php echo e($metaPuntos); ?> puntos para nuevo rango</p>
                                    </div>
                                    <span class="text-sm font-black text-[#e91e63]"><?php echo e($avancePuntos); ?>%</span>
                                </div>
                                <div class="h-2 w-full overflow-hidden rounded-full bg-slate-100">
                                    <div class="h-full rounded-full bg-gradient-to-r from-[#e91e63] to-[#ff6b9d]" style="width: <?php echo e($avancePuntos); ?>%"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-auto pt-6 grid grid-cols-3 gap-4 border-t border-slate-100">
                            <div>
                                ...
                                <p class="mt-1 text-2xl font-black text-slate-900"><?php echo e($pedidosTotales); ?></p>
                            </div>
                            <div>
                                <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400">Puntos Netos</p>
                                <p class="mt-1 text-2xl font-black text-[#e91e63]"><?php echo e($puntosTotal); ?></p>
                            </div>
                            <div>
                                <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400">Unidades</p>
                                <p class="mt-1 text-2xl font-black text-[#294395]"><?php echo e($unidadesTotales); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-3xl bg-white p-0 ring-1 ring-slate-200/60 shadow-sm lg:col-span-5 flex flex-col overflow-hidden">
                    <div class="flex items-center justify-between p-6 pb-4 border-b border-slate-100">
                        ...
                        <a href="<?php echo e(url('/mis-pedidos')); ?>" class="text-xs font-bold uppercase tracking-wider text-[#294395] hover:text-[#e91e63] transition-colors">Ver historial</a>
                    </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $pedidosRecientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex items-center justify-between p-4 rounded-2xl hover:bg-slate-50 transition-colors">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-slate-900">Pedido #<?php echo e($pedido->codigo_pedido ?? $pedido->id); ?></p>
                                        <p class="text-xs text-slate-500 mt-0.5"><?php echo e($pedido->fecha ?? $pedido->created_at?->format('d/m/Y') ?? 'Sin fecha'); ?></p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <p class="text-sm font-black text-[#e91e63]"><?php echo e($pedido->total_puntos ?? 0); ?> <span class="text-[10px] uppercase text-slate-400">pts</span></p>
                                    <p class="text-[10px] font-bold uppercase tracking-wider text-slate-400 mt-1"><?php echo e(ucfirst($pedido->estado ?? 'Revisión')); ?></p>
                                </div>
                            </div>
            ...
            <section class="space-y-6">
                <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm">
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                        ...
                        <form method="GET" action="<?php echo e(route('dashboard')); ?>" class="flex flex-wrap items-end gap-3 rounded-2xl bg-slate-50 p-3 ring-1 ring-slate-100">
                            <label class="flex flex-col gap-1.5">
                                ...
                                <select name="filtro" class="h-10 rounded-xl border-0 bg-white px-4 text-sm font-bold text-slate-700 ring-1 ring-slate-200 focus:ring-2 focus:ring-[#294395] cursor-pointer">
                                    <option value="mes" <?php if($filtroAdmin === 'mes'): echo 'selected'; endif; ?>>Mensual</option>
                                    <option value="rango" <?php if($filtroAdmin === 'rango'): echo 'selected'; endif; ?>>Rango personalizado</option>
                                </select>
                            </label>

                            <label class="flex flex-col gap-1.5">
                                <span class="text-[10px] font-bold uppercase tracking-wider text-slate-500 px-1">Mes</span>
                                <input name="mes" type="month" value="<?php echo e($mesAdmin); ?>" class="h-10 rounded-xl border-0 bg-white px-4 text-sm font-bold text-slate-700 ring-1 ring-slate-200 focus:ring-2 focus:ring-[#294395]" />
                            </label>

                            <label class="flex flex-col gap-1.5">
                                <span class="text-[10px] font-bold uppercase tracking-wider text-slate-500 px-1">Desde</span>
                                <input name="fecha_inicio" type="date" value="<?php echo e($fechaInicioAdmin); ?>" class="h-10 rounded-xl border-0 bg-white px-4 text-sm font-bold text-slate-700 ring-1 ring-slate-200 focus:ring-2 focus:ring-[#294395]" />
                            </label>

                            <label class="flex flex-col gap-1.5">
                                <span class="text-[10px] font-bold uppercase tracking-wider text-slate-500 px-1">Hasta</span>
                                <input name="fecha_fin" type="date" value="<?php echo e($fechaFinAdmin); ?>" class="h-10 rounded-xl border-0 bg-white px-4 text-sm font-bold text-slate-700 ring-1 ring-slate-200 focus:ring-2 focus:ring-[#294395]" />
                            </label>
                ...
                <div class="grid gap-6 md:grid-cols-3">
                    <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm border-l-4 border-l-[#294395]">
                        ...
                        <p class="text-3xl font-black text-slate-900"><?php echo e(number_format($resumenAdmin['unidades_vendidas'], 0, ',', '.')); ?></p>
                    </div>
                    <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm border-l-4 border-l-indigo-400">
                        ...
                        <p class="text-3xl font-black text-slate-900"><span class="text-slate-400 text-2xl mr-1">$</span><?php echo e(number_format($resumenAdmin['total_catalogo_vendido'], 2, ',', '.')); ?></p>
                    </div>
                    <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm border-l-4 border-l-[#e91e63]">
                        ...
                        <p class="text-3xl font-black text-[#e91e63]"><span class="text-[#e91e63]/50 text-2xl mr-1">$</span><?php echo e(number_format($resumenAdmin['total_facturado'], 2, ',', '.')); ?></p>
                    </div>
                </div>
                ...
                <div class="grid gap-6 lg:grid-cols-2">
                    ...
                    <div class="rounded-3xl bg-white ring-1 ring-slate-200/60 shadow-sm overflow-hidden flex flex-col">
                        ...
                        <div class="overflow-x-auto p-2">
                            <table class="w-full text-left text-sm whitespace-nowrap">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $ultimosPedidosAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-slate-50 rounded-xl transition-colors">
                                            <td class="px-4 py-3 font-bold text-[#294395]">#<?php echo e($pedido->codigo_pedido); ?></td>
                                            <td class="px-4 py-3 text-slate-500"><?php echo e($pedido->fecha ? Carbon::parse($pedido->fecha)->format('d/m/Y') : 'N/A'); ?></td>
                                            <td class="px-4 py-3 font-medium text-slate-700"><?php echo e($pedido->vendedora?->name ?? 'Sin vendedora'); ?></td>
                                            <td class="px-4 py-3 text-right font-black text-slate-900">$<?php echo e(number_format((float) $pedido->total_a_pagar, 2, ',', '.')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="rounded-3xl bg-white ring-1 ring-slate-200/60 shadow-sm overflow-hidden flex flex-col">
                        ...
                        <div class="overflow-x-auto p-2">
                            <table class="w-full text-left text-sm whitespace-nowrap">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $ultimosRegistrosAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-slate-50 rounded-xl transition-colors">
                                            <td class="px-4 py-3 font-bold text-slate-900"><?php echo e($registro->name); ?></td>
                                            <td class="px-4 py-3 text-slate-500 text-xs"><?php echo e($registro->email); ?></td>
                                            <td class="px-4 py-3 text-right text-slate-500 text-xs"><?php echo e($registro->created_at?->format('d/m/y H:i')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm">
                        ...
                        <div class="space-y-3">
                            <?php $__empty_1 = true; $__currentLoopData = $topVendedorasAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $vendedora): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="flex items-center justify-between p-3 rounded-2xl bg-slate-50 border border-slate-100/50">
                                    <div class="flex items-center gap-3">
                                        <span class="flex h-6 w-6 items-center justify-center rounded-full bg-white text-[10px] font-black text-slate-400 ring-1 ring-slate-200 shadow-sm"><?php echo e($index + 1); ?></span>
                                        <span class="font-bold text-slate-700 text-sm"><?php echo e($vendedora->name); ?></span>
                                    </div>
                                    <span class="font-black text-[#e91e63] text-sm">$<?php echo e(number_format((float) $vendedora->total_ventas, 2, ',', '.')); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="rounded-3xl bg-white p-6 ring-1 ring-slate-200/60 shadow-sm">
                        ...
                        <div class="space-y-3">
                            <?php $__empty_1 = true; $__currentLoopData = $topLideresAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="flex items-center justify-between p-3 rounded-2xl bg-slate-50 border border-slate-100/50">
                                    <div class="flex items-center gap-3">
                                        <span class="flex h-6 w-6 items-center justify-center rounded-full bg-white text-[10px] font-black text-slate-400 ring-1 ring-slate-200 shadow-sm"><?php echo e($index + 1); ?></span>
                                        <span class="font-bold text-slate-700 text-sm"><?php echo e($lider->name); ?></span>
                                    </div>
                                    <span class="font-black text-[#294395] text-sm">$<?php echo e(number_format((float) $lider->total_ventas, 2, ',', '.')); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="p-4 text-center text-xs text-slate-400">Sin datos para mostrar.</div>
                            <?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/unquxtyh/public_html/resources/themes/anchor/pages/dashboard/index.blade.php ENDPATH**/ ?>