...
?>
<!--[if BLOCK]><![endif]--><?php if(isset($seo->title)): ?>
...
<?php if(isset($seo->title) && isset($seo->description) && isset($seo->image)): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if(isset($seo->image_w) && isset($seo->image_h)): ?>
...
<!--[if BLOCK]><![endif]--><?php if(isset($seo->description)): ?>
...
?>
<!--[if BLOCK]><![endif]--><?php if($customCss !== ''): ?>
