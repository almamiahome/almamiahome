...
<div class="grid gap-8 lg:grid-cols-12">
        ...
        <div class="p-8 bg-white/60 dark:bg-zinc-900/40 backdrop-blur-xl rounded-[2.5rem] border border-white/60 shadow-xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-4 bg-white/50 dark:bg-zinc-800/50 rounded-2xl border border-white shadow-sm flex items-start gap-4">
                    <x-phosphor-cpu-bold class="w-6 h-6 text-indigo-500" />
                    <div>
                ...
                <div class="p-4 bg-white/50 dark:bg-zinc-800/50 rounded-2xl border border-white shadow-sm flex items-start gap-4">
                    <x-phosphor-palette-bold class="w-6 h-6 text-indigo-500" />
                    <div>
                ...
                <div class="p-4 bg-white/50 dark:bg-zinc-800/50 rounded-2xl border border-white shadow-sm flex items-start gap-4">
                    <x-phosphor-lightning-bold class="w-6 h-6 text-indigo-500" />
                    <div>
                ...
                <div class="p-4 bg-white/50 dark:bg-zinc-800/50 rounded-2xl border border-white shadow-sm flex items-start gap-4">
                    <x-phosphor-shield-check-bold class="w-6 h-6 text-indigo-500" />
                    <div>
    ...
    <div class="lg:col-span-5">
        <div class="h-full p-8 bg-zinc-900 dark:bg-black rounded-[2.5rem] shadow-2xl relative overflow-hidden group border border-zinc-800">
            <x-phosphor-folder-open-bold class="absolute top-0 right-0 w-48 h-48 text-white/[0.03] -mt-10 -mr-10 group-hover:text-indigo-500/10 transition-colors duration-500" />
            
            <h3 class="text-xl font-black text-white mb-8 flex items-center gap-2">
                <x-phosphor-tree-structure-bold class="w-6 h-6 text-indigo-400" />
                Estructura clave
            </h3>
