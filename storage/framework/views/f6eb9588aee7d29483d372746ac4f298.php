...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e1fe0a65a45e979f68b20da5606ecdcc::app.container','data' => ['class' => 'space-y-6 pb-20','xData' => '{ tab: \'explorer\' }']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'space-y-6 pb-20','x-data' => '{ tab: \'explorer\' }']); ?>
                ...
                <div class="space-y-2">
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400 font-medium">
                        ...
                        <code class="font-mono text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/30 px-2 py-0.5 rounded ml-1">
                            resources/themes/anchor/<?php echo e($currentDir ?: ''); ?>
            ...
            <div class="bg-white dark:bg-zinc-900/80 border border-slate-200 dark:border-zinc-800 rounded-b-[2rem] rounded-tr-[2rem] shadow-xl overflow-hidden min-h-[70vh] flex flex-col">
                    ...
                    <div class="flex items-center justify-between border-b border-slate-100 dark:border-zinc-800/50 px-6 py-4 bg-slate-50/50 dark:bg-zinc-900/50">
                        <div class="space-y-1">
                            ...
                            <p class="text-xs font-mono text-slate-500 dark:text-slate-400 bg-white dark:bg-zinc-800 px-2 py-1 rounded border border-slate-200 dark:border-zinc-700">
                                <?php echo e($currentDir === '' ? '/' : '/' . $currentDir); ?>
                    ...
                    <div class="flex-1 overflow-y-auto px-6 py-4 text-sm bg-white dark:bg-zinc-900/30">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="space-y-1">
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $directories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dir): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <button
                                            type="button"
                                            wire:click="changeDir('<?php echo e($currentDir === '' ? $dir : $currentDir . '/' . $dir); ?>')"
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="space-y-1">
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <button
                                            type="button"
                                            wire:click="openFile('<?php echo e($file); ?>')"
                                            ...
                                            class="group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left transition-all
                                                <?php echo e($selectedFile === $file ? 'bg-indigo-50 border border-indigo-200 dark:bg-indigo-900/20 dark:border-indigo-500/30 shadow-sm' : 'hover:bg-slate-100 dark:hover:bg-zinc-800'); ?>"
                                        >
                                            <span class="text-lg text-sky-500 dark:text-sky-400 drop-shadow-sm group-hover:scale-110 transition-transform">
                                                <?php echo e(Str::endsWith($file, ['.php', '.blade.php']) ? '🐘' : (Str::endsWith($file, ['.js', '.json']) ? '🟨' : '📄')); ?>

                                            </span>
                                            <span class="font-medium truncate <?php echo e($selectedFile === $file ? 'text-indigo-700 dark:text-indigo-300 font-bold' : 'text-slate-700 group-hover:text-indigo-600 dark:text-slate-300 dark:group-hover:text-indigo-400'); ?>">
                                                <?php echo e($file); ?>

                                            </span>
                                            <!--[if BLOCK]><![endif]--><?php if($selectedFile === $file): ?>
                ...
                <div x-show="tab === 'editor'" style="display: none;" x-transition.opacity class="flex-1 flex flex-col h-full bg-[#f8f9fa] dark:bg-[#282a36]">
                        ...
                        <div class="space-y-1">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm font-bold text-slate-800 dark:text-slate-100 font-mono">
                                    <?php echo e($selectedFile ? $this->displayPath() : 'Ningún archivo seleccionado'); ?>

                                </span>
                            </div>
                            <p class="text-[11px] text-slate-500 dark:text-slate-400">
                                <?php echo e($statusMessage ?: 'Seleccioná un archivo desde la pestaña Explorador para comenzar a editar.'); ?>
                    ...
                    <div class="flex-1 relative" id="editor-container" wire:ignore data-filename="<?php echo e($selectedFile); ?>">
                        <!--[if BLOCK]><![endif]--><?php if($selectedFile): ?>
...
<?php endif; ?>
    <?php /**PATH /home/unquxtyh/public_html/storage/framework/views/47f3809cf3c677efdcc2df0a639c8c68.blade.php ENDPATH**/ ?>